...
# def local_video_to_list(video_path: str) -> str:
...
def local_video_to_base64(video_path: str) -> str:
    ...
    for message in content_messages:
        ...
        for part_message in message_content_list:
            if 'video' in part_message:
                ...
                part_message = f"data:video/jpeg;base64,{','.join(base64_frames)}"
                return part_message, {'fps': fps_list}
    #         new_content_list.append(part_message)
    #     message["content"] = new_content_list
    #     vllm_messages.append(message)
    #     video_url = f"data:video/jpeg;base64,{','.join(base64_frames)}"
    # return video_url, {'fps': fps_list}
